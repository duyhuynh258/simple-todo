...
/// @nodoc
class _$TaskRemoteDataSourceExceptionTearOff {
  const _$TaskRemoteDataSourceExceptionTearOff();
...
/// @nodoc
const $TaskRemoteDataSourceException = _$TaskRemoteDataSourceExceptionTearOff();

/// @nodoc
mixin _$TaskRemoteDataSourceException {
  @optionalTypeArgs
...
/// @nodoc
abstract class $TaskRemoteDataSourceExceptionCopyWith<$Res> {
  factory $TaskRemoteDataSourceExceptionCopyWith(
          TaskRemoteDataSourceException value,
          $Res Function(TaskRemoteDataSourceException) then) =
      _$TaskRemoteDataSourceExceptionCopyWithImpl<$Res>;
}

/// @nodoc
class _$TaskRemoteDataSourceExceptionCopyWithImpl<$Res>
    implements $TaskRemoteDataSourceExceptionCopyWith<$Res> {
  _$TaskRemoteDataSourceExceptionCopyWithImpl(this._value, this._then);

  final TaskRemoteDataSourceException _value;
  // ignore: unused_field
  final $Res Function(TaskRemoteDataSourceException) _then;
}
...
class _$_NoInternet extends _NoInternet {
  ...
  @override
  String toString() {
    return 'TaskRemoteDataSourceException.noInternet()';
  }
