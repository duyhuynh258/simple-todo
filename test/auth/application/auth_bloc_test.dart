...
void main() {
  ...
  group('AuthBloc', () {
    ...
    blocTest<AuthBloc, AuthState>('Emit unauthenticated when no user signed in',
        setUp: () {
          when(() => authRepositoryMock.onUserChanged)
              .thenAnswer((invocation) => Stream.value(dartz.optionOf(null)));
    ...
    blocTest<AuthBloc, AuthState>('Emit authenticated when user signed in.',
        setUp: () {
    ...
    blocTest<AuthBloc, AuthState>(
        ...
        setUp: () {
          ...
          when(() => authRepositoryMock.signOut())
              .thenAnswer((invocation) => Future.value(null).then((value) {
